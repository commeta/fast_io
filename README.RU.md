...
Если функция Fast_IO пытается прочитать или записать в файл, который имеет установленную блокировку flock LOCK_EX, операция будет ожидать освобождения блокировки другим процессом.
