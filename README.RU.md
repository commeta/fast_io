...
Если необходимо изменить значение параметра навсегда для всех скриптов и сервера, рекомендуется внести изменения в файл конфигурации php.ini и перезапустить сервер. В этом случае значение параметра будет обновлено для всех скриптов, запущенных на сервере.
