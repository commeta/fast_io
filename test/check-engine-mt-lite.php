 ...
 * 
 * check-engine-mt-lite.php — МНОГОПРОЦЕССНЫЙ СТРЕСС-ТЕСТ fast_io 
 * 
 * Поддержка параметров: php check-engine-mt-lite.php [workers=12] [iterations=120]
 * Запуск: php check-engine-mt-lite.php 12 120
 * 
...
if ($failed === 0 && ($analize['flow_interruption'] ?? 0) === 0 && ($analize['line_count'] ?? 0) > 100) {
    echo "\n✅ check-engine-mt-lite.php — УСПЕШНО ПРОЙДЕН\n";
