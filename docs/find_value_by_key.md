...
- 3: Поиск по регулярному выражению PCRE2 в каждой строке, без учёта разделителей, возвращает первую найденную строку целиком.
- 4: Поиск строк в которых есть совпадение по регулярному выражению PCRE2, возвращает количество найденных строк.
