...
- 1: Поиск index_key в каждой строке, без учёта разделителей, возвращает строку целиком.
...
- 3: Поиск строк в которых найден index_key, возвращает (через запятую) номера строк в которых был найден index_key.
- 4: Поиск по регулярному выражению PCRE2 в каждой строке, без учёта разделителей, возвращает строку целиком.
- 5: Поиск строк в которых есть совпадение по регулярному выражению PCRE2, возвращает (через запятую) номера строк.
