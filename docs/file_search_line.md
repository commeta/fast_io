...
#### Режимы поиска
- 0, 1: Поиск line_key в каждой строке, без учёта разделителей, возвращает первую найденную строку целиком.
- 10, 11: Поиск по регулярному выражению [PCRE2](https://pcre2project.github.io/pcre2/doc/html/index.html) в каждой строке, без учёта разделителей, возвращает первую найденную строку целиком.

В режимах: 1, 11 возвращается строка без пробелов справа и символа перевода строки.
