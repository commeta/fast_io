...
- 20: Поиск по регулярному выражению [PCRE2](https://pcre2project.github.io/pcre2/doc/html/index.html) в каждой строке, полнотекстовый поиск, возвращает ассоциативный массив включая подстроки совпавшие с регулярным выражением.
...
(
    [0] => Array
        (
            [0] => Array
                (
                    [line] => index_0 file_insert_line_0 12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012
                    [matches] => Array
                        (
                            [0] => index_0
