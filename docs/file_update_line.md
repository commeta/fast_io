...
- mode (int, optional) - Режим адресации: 0 по номеру строки, 1 по смещению строки. Если добавить +100 к любому из вышеперечисленных режимов, функция пересчитает режим mode -= 100 но не будет блокировать файл.
